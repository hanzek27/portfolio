...
export default function UI() {
  ...
  modeSwitcher(mode)
  return (
    <main className="h-full grid grid-rows-[30px_1fr_30px] bg-light dark:bg-dark overflow-y-auto overflow-x-hidden p-page-sm md:p-page-md lg:p-page-lg">
      <div>
        <Header />
      </div>
      <section className='grid grid-cols-[30px_1fr_30px]'>
